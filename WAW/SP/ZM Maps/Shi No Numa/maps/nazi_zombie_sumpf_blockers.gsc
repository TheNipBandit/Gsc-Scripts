...
// Shi No Numa buyable doors use targetname zombie_double_door (swing doors), not zombie_door.
// Standard debris still uses zombie_debris via maps\_zombiemode_blockers. Shepherd Lobby Menu
// "Doors + Debris Costs" applies flat pricing to zombie_door, zombie_double_door, and zombie_debris.
