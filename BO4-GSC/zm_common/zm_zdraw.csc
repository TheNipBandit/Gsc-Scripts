...
zdraw_command(var_a99ac828, startat, toplevel) {
...
zdraw_line(var_a99ac828, startat) {
...
zdraw_text(var_a99ac828, startat) {
...
zdraw_color(var_a99ac828, startat) {
  if(isDefined(var_a99ac828[startat])) {
    if(function_b0f457f2(var_a99ac828[startat])) {
      var_769ff4d7 = zdraw_vector(var_a99ac828, startat);
...
zdraw_alpha(var_a99ac828, startat) {
  if(isDefined(var_a99ac828[startat])) {
...
zdraw_scale(var_a99ac828, startat) {
  if(isDefined(var_a99ac828[startat])) {
    var_769ff4d7 = revive_getDvar(var_a99ac828, startat);
...
zdraw_duration(var_a99ac828, startat) {
  if(isDefined(var_a99ac828[startat])) {
    var_769ff4d7 = revive_getDvar(var_a99ac828, startat);
...
zdraw_vector(var_a99ac828, startat) {
  if(isDefined(var_a99ac828[startat])) {
    var_769ff4d7 = revive_getDvar(var_a99ac828, startat);
