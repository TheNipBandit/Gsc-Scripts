...
func_5EA8(param_00,param_01)
{
	...
	switch(level.gametype)
	{
		...
		case "dom":
			...
			var_3F = level.var_3211[0].var_A582[0].origin;
			var_40 = level.var_3211[0].var_6DB2;
			var_41 = level.var_3211[1].var_A582[0].origin;
			var_42 = level.var_3211[1].var_6DB2;
			var_43 = level.var_3211[2].var_A582[0].origin;
		...
		case "ctf":
			...
			var_14 = distance2d(self.var_9092,level.var_9853[self.team].origin);
			var_15 = distance2d(self.var_9092,level.var_9853[maps\mp\_utility::func_45DE(self.team)].origin);
			var_4B = var_14;
			var_4C = var_15;
			var_4D = var_16;
