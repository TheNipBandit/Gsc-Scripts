...
func_63AC(param_00)
{
	...
	for(;;)
	{
		...
		{
			if(maps\mp\_utility::isdivisionsglobaloverhaulenabled() && self.var_79 == 6 && isdefined(self.pers["resistanceScramblerIndicatorActive"]))
			{
			}
			else
			{
